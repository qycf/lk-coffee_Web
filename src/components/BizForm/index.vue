<template>
    <van-form @submit="onSubmit">
        <van-cell-group inset>
            ...
            <van-field v-model="formData.tel" clearable name="tel" label="手机号" placeholder="手机号"
        ...
        <div class="mt-4" v-if="!isReg">
            <div class="ml-6 float-left text-slate-400" @click="usePwdLogin">{{ !isUsePwd ? '切换密码登录' : '切换验证码登录' }}
            </div>
...
import UserAgreementField from '@/components/UserAgreementField/index.vue';
import PwdField from '@/components/PwdField/index.vue';
import CodeField from '@/components/CodeField/index.vue';
import { ref } from 'vue';
